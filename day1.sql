...
Database: The place where data related to each other exist.
...
GRANT: Used to authorize the user
REVOKE: Used to revoke the privilige users.

*/
--How to create table
--1. Way: Create table fom strach
...
--While we create a table,we can put some "Constraints" for fiels
--Constraints:
--a) Unique
--b) Not null
--c) Primary Key
...
CREATE TABLE students
(
student_id SMALLINT PRIMARY KEY,--student_id can not have duplicate and null value
student_name VARCHAR(50) NOT NULL,--student_name field can not have null value
student_age SMALLINT,
student_dob DATE UNIQUE--student_dob field con not have dublicate value
);
--2 Way:
CREATE TABLE students
(
...
student_dob DATE,
	CONSTRAINT student_age_check CHECK(student_age BETWEEN 15 and 20),--15 and 20 are inklusive
...
INSERT INTO students VALUES(102,'AYSE TAN',15,'23-Feb-2008')
--For varchar we have to use single quotes
INSERT INTO students VALUES(103,'JOHN DOE',19,'22-May-2004');
--2. Way: Insert data for specific field
